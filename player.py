...
play_list = Listbox(root, font="Sansarif 12 bold", bd=5,
                    bg="cyan", width=37, height=19, selectbackground="black")
...
img = PhotoImage(file="FLSQT1.png", width=500, height=460)
lab = Label(root)
lab.grid()
lab["compound"] = LEFT
lab["image"] = img
...
button_play = Button(root, text=PLAY, width=5, bd=5, bg="green",
...
button_load_music = Button(root, text="♫ Click Here To Load The Music ♫", width=43,
                           bd=5, font="Helvetica, 10", bg="green", fg="white", command=add_songs_playlist)
